      ...
      <div class="ms-auto">
        <div class="btn-group">
          ...
          <div class="dropdown-menu dropdown-menu-right dropdown-menu-lg-end">
            <NuxtLink class="dropdown-item" to="/nexus.lab/testtype/create">
              <Translate text="New single test type"/>
            </NuxtLink>
            <NuxtLink class="dropdown-item" to="/nexus.lab/grouptesttype/create">
                      ...
                      <table id="onetoabc" class="table table-striped table-bordered dttable" role="grid" aria-describedby="example2_info">
                        ...
                        <tbody>
                          <tr role="row" v-for="(u,i) in testtypes" :class="i%2==0 ? 'even' : 'odd'" :key="'account-'+i">
                            ...
                            <td>
                              <NuxtLink class="btn btn-primary btn-sm" :to="u.type=='SINGLE' ? ('/nexus.lab/testtype/'+u.id) : ('/nexus.lab/grouptesttype/'+u.id)">
      ...
      if(window.confirm("Are you sure you want to duplicate this test: "+d.name+" ?")){
        getRequestLoad_(
          ...
          (r)=>{
              ...
              if(d.type=='SINGLE'){
                context.$router.push("/nexus.lab/testtype/"+r.id);
              }else{
                context.$router.push("/nexus.lab/grouptesttype/"+r.id);
              }
          }
        )
      }
