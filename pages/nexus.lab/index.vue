<template>
    <NuxtLayout name="lablayout">
              ...
              <div>
                ...
                <HasPermission perm="LABORATORY.VIEW_STATS">
                  <br/>
                <br/>
                ...
                <HasPermission perm="PATIENT.VIEW_PATIENT_PROFILE">
                    <br/>
                    <br/>
                      <!-- start -->
                    <div class="row">
                            ...
                            <!-- class="card-body" -->
                              <div > 
                                <div  class="d-flex justify-content-between align-items-center">
                                  ...
                                  <strong><u><NuxtLink to="/nexus.lab/specimens"><Translate text="View All"/> &rightarrow;</NuxtLink></u></strong>
                                </div>
                                <br/>
                ...
                <HasNoPermission perm="LABORATORY.VIEW_STATS,PATIENT.VIEW_PATIENT_PROFILE">
                    <div style="height:80vh;width:100%;display:flex;align-items: center; justify-content: center; flex-direction:column">
                        <img src="/assets/cropped-HBR-logo.png" class="" style="height: 100px;"/>
                        <h1><Translate text="HealthBridge Nexus Laboratory!"/></h1>
