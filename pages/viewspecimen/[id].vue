<template>
    <NuxtLayout name="inner">
                ...
                <div class="container mt-2 mb-3" v-if="specimen">
                   ...
                   <div class="row">
                        ...
                        <div class="col-sm-4 d-flex">
                            <NuxtLink class="btn btn-primary btn-sm my-3 mb-5" target="_blank" v-if="meta[0] && meta[0].validated && hasPermission('EXPORT_SHEET')" :to="baseUrl+'/test-report?id='+specimen.id+'&multiple=true'">
                              <Translate text="View PDF"/>
                            </NuxtLink>
                            <a class="btn btn-primary btn-sm my-3 mb-5 ms-4" target="_blank" 
                               v-if="meta[0] && meta[0].validated  && hasPermission('EXPORT_SHEET')"  
            ...
            <div class="d-flex align-items-end justify-content-end" v-if="!meta[0].validated&& hasPermission('ENTER_RESULTS')">
                <button type="submit" class="btn btn-primary btn-sm">
                  + {{ canValidate ? $t("Update Results") : $t("Save Results") }}
                </button>
            </div>
            
                <div v-if="canValidate&& hasPermission('VALIDATE_RESULTS')">
  ...
  export default{
    setup(){
        forceOutPermissionVerify('ENTER_RESULTS,VIEW_TEST_RESULTS,VALIDATE_RESULTS',this); 
    },
    mounted(){
      const context=this;
      setTimeout(function(){
