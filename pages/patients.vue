                ...
                <div class="ms-auto">
                  <div class="btn-group">
                    ...
                    <div class="dropdown-menu dropdown-menu-right dropdown-menu-lg-end"> <NuxtLink class="dropdown-item"
                        to="/new/patient">New patient</NuxtLink>
                    </div>
                  </div>
                </div>
              </div>
                                  ...
                                  <table id="onetoabc" class="table table-striped table-bordered dttable " role="grid" aria-describedby="example2_info">
                                    ...
                                    <tr role="row" v-for="(u,i) in users" :class="i%2==0?'even':'odd'" :key="'account-'+i">
                                      ...
                                      <td class="">{{ u.reference }}</td>
                                            ...
                                            <td>
                                                <NuxtLink class="btn btn-primary btn-sm me-2" :to="'/profile/'+u.id">View Profile</NuxtLink>
                                                <NuxtLink class="btn btn-primary btn-sm" :to="'/addspecimen/'+u.id">Add Specimen</NuxtLink>
                                            </td>
