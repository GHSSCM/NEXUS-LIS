<template>
  <HbPage layoutName="bloodbanklayout"
          ...
          sectionName="Nexus Blood Bank" title="List of donations"   :options="[{label:'New donation',path:'/nexus.bloodbank/select-patient'},{label:'New Random donation',path:'/nexus.bloodbank/donation/create'}]">
    <HbTable url="/nx/donations/" :params="{operation:'DONATION'}" ></HbTable>
  </HbPage>
</template>
