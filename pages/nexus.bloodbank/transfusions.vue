<template>
  <HbPage layoutName="bloodbanklayout"
          ...
          sectionName="Nexus Blood Bank" title="List of transfusions"   :options="[{label:'New transfusion',path:'/nexus.bloodbank/select-patient-trans'},{label:'New Random donation',path:'/nexus.bloodbank/transfusion/create'}]">
    <HbTable url="/nx/donations/" :params="{operation:'TRANSFUSION'}" ></HbTable>
  </HbPage>
</template>
