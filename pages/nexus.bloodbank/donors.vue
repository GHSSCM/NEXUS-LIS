<template>
  <HbPage layoutName="bloodbanklayout"
          ...
          sectionName="Nexus Blood Bank" title="List of donors"   :options="[{label:'New donation',path:'/nexus.bloodbank/select-patient'},{label:'New Random donation',path:'/nexus.bloodbank/donation/create'}]">
    <HbTable url="/nx/donors/" ></HbTable>
  </HbPage>
</template>
