<template>
  <HbPage layoutName="bloodbanklayout"
          ...
          sectionName="Nexus Blood Bank" :title="pageId==='create'?`Register transfusion`:`Edit Transfusion Information`"  >
    <div>
      ...
      <form @submit.prevent="save">
        <div class="row">
          ...
          <div class="col-sm-12 col-md-6">
            <div class="mb-4">
              <label class="form-label">
                <Translate text="Transfusion Date/Time "/>
              </label>
    ...
    save(){
      ...
      if(this.pageId==="create"){
        postRequestLoad_('/nx/donations/',this.donation,(fields)=>{
          context.$router.push('/nexus.bloodbank/transfusions')
          successToast(this.$t("Transfusion registered successfully"))
        })
      }else{
        postRequestLoad_('/nx/donations/'+this.pageId,this.donation,(fields)=>{
          successToast(this.$t("Transfusion updated successfully"))
        },()=>{
        })
      }
    }
