              ...
              <div>
                ...
                <div class="row">
                    ...
                    <div class="mb-4">
                        ...
                        <select multiple class="form-select multiple-select-field" id="single-select-field2" data-placeholder="Compatible specimen(s)">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12 col-md-6">
                        ...
                        <div class="mb-4">
                            ...
                            <input class="form-control" type="number" placeholder="Prevalence Threshold"/>
                          </div>
