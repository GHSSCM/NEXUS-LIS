<template>
                                   ...
                                   <table id="onetoabc" class="table table-striped table-bordered dttable " role="grid" aria-describedby="example2_info">
                                     ...
                                     <tr role="row" v-for="(u,i) in specimens" :class="i%2==0?'even':'odd'" :key="'account-'+i">
                                             ...
                                             <td>
                                              ...
                                              <NuxtLink class="btn btn-primary btn-sm me-3" v-if="!u.meta.validated && hasPermission('REGISTER_SPECIMEN')" :to="'/editspecimen/'+u.id"><Translate text="Edit"/></NuxtLink>
  ...
  export default{
    setup(){
      forceOutPermissionVerify('REGISTER_SPECIMEN',this); 
    },
    data(){
        return {
          specimens:[],
