  ...
  <NuxtLayout name="lablayout">
          ...
          <div class="ms-auto">
              <div class="btn-group">
                  ...
                  <div class="dropdown-menu dropdown-menu-right dropdown-menu-lg-end"> 
                      <NuxtLink to="/nexus.patients/patientinfo/create" class="dropdown-item">
                          <Translate text="New patient" />
                      </NuxtLink>
                  </div>
              </div>
      ...
      <div>
                  ...
                  <table class="table mb-0 table-hover">
                      ...
                      <tbody>
                          <tr v-for="(r,i) in results" :key="'sr-'+i">
                              ...
                              <td>{{r.profession}}</td>
                              <td>
                                  <NuxtLink class="btn btn-sm btn-primary" :to="'/nexus.patients/profile/'+r.id">
          ...
          <div class="d-flex flex-row justify-content-end" v-if="searchname">
              <NuxtLink class="btn btn-primary w-100" :to="'/nexus.patients/patientinfo/create?name='+searchname">
