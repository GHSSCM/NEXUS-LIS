...
export class Permission{
    ...
    static LABORATORY_VIEW_STATS= "LABORATORY.VIEW_STATS";
    static LABORATORY_REGISTER_SPECIMEN="LABORATORY.REGISTER_SPECIMEN";
    static LABORATORY_ENTER_RESULTS="LABORATORY.ENTER_RESULTS";
    static LABORATORY_VIEW_TEST_RESULTS="LABORATORY.VIEW_TEST_RESULTS";
    static LABORATORY_VALIDATE_RESULTS="LABORATORY.VALIDATE_RESULTS";
    static LABORATORY_MANAGE_BILLING="LABORATORY.MANAGE_BILLING";
    static LABORATORY_EXPORT_SHEET="LABORATORY.EXPORT_SHEET";
    static LABORATORY_MANAGE_TEST_TYPE="LABORATORY.MANAGE_TEST_TYPE";
    static LABORATORY_MANAGE_SPECIMEN_TYPE="LABORATORY.MANAGE_SPECIMEN_TYPE";


    // patient related permissions
    static PATIENT_CREATE_PATIENT="PATIENT.CREATE_PATIENT";
    static PATIENT_VIEW_PATIENT_PROFILE="PATIENT.VIEW_PATIENT_PROFILE";
    static PATIENT_VIEW_PATIENTS="PATIENT.VIEW_PATIENTS";
    static PATIENT_MODIFY_PATIENT_INFO="PATIENT.MODIFY_PATIENT_INFO";


    // configuration related permissions
    static CONFIGURATION_MANAGE_META="CONFIGURATION.MANAGE_META";
    static CONFIGURATION_MANAGE_APP_CONFIG="CONFIGURATION.MANAGE_APP_CONFIG";


    // billing related permissions
    static BILLING_CREATE_BILL="BILLING.CREATE_BILL";
    static BILLING_VIEW_BILL="BILLING.VIEW_BILL";
